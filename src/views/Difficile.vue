...
export default {
  ...
  methods: {
    click1(){
        if (!this.clicked){
            ...
            if(this.dilemme.bouton1 === this.dilemme.Bon){
                ...
                this.score += (100*(1-Math.abs(this.dilemme.M1 - this.dilemme.M)/1.6))
            }
        }
    },
    click2(){
        if (!this.clicked){
            ...
            if(this.dilemme.bouton2 === this.dilemme.Bon){
                ...
                this.score += (100*(1-Math.abs(this.dilemme.M2 - this.dilemme.M)/1.6))
            }
        }
    },
    chargement(){
    ...
    suivant(){
        if(this.numéro === 5){
            ...
            let étoiles = localStorage.getItem("étoiles_difficile_courrante");
            localStorage.setItem("étoiles_difficile_courrante", Math.floor(this.score/100).toString());
            localStorage.setItem("étoiles_difficile", Math.max(Math.floor(this.score/100), étoiles));
            étoiles = localStorage.getItem("étoiles_difficile_courrante");
            
            this.étoiles_difficile = Number(étoiles);
  ...
  try {
    document.querySelectorAll("audio").forEach(e=>{
      ...
      audio.src = "/public/audio/fondDifficile.mp3";
      audio.autoplay = true;
      audio.loop = true;
      const body = document.querySelector("body");
      body.appendChild(audio);

    const response = await fetch('/public/json/difficile.json');
    ...
    <div class="center colonne">
        <div class="plan-container">
            <a :href="dilemme.href"><img :src="dilemme.src_plan" class="img-rails" alt="rails" title="made at imgflip.com" loading="lazy">
                ...
                <!-- soucoupe -->
                <a v-if="dilemme.voie2_type === 'soucoupe'" href="https://imgflip.com/i/ancqwb">
                <img src="../../public/img/soucoupeFaite.png" title="made at imgflip.com" class="soucoupe"/></a>
                <!-- voie 1 -->
                <div v-if="dilemme.voie1 > 0" v-for="n in dilemme.voie1">
                    ...
                    <img :key="n" v-if="dilemme.voie1_type === 'voluntary person'" src="../../public/img/VolontaireAtttaché.png" alt="" loading="lazy" class="Vperson voie1">
                </div>
                <!-- voie 2 -->
            <div v-if="dilemme.voie2 > 0" v-for="n in dilemme.voie2">
                ...
                <img :key="n" v-if="dilemme.voie2_type === 'voluntary person'" src="../../public/img/VolontaireAtttaché.png" alt="" loading="lazy" class="Vperson voie2">
            </div>
            </a>
        </div>
